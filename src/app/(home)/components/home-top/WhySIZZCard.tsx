export default function WhySIZZCard() {
    ...
    return (
        <div
            className={`
                flex flex-col gap-4 w-[260px] sm:w-[280px] md:w-[300px]
                translate-x-[5vw] translate-y-[8vh]
                sm:translate-x-[15vw] sm:translate-y-[10vh]
                md:translate-x-[25vw] md:translate-y-[12vh]
                lg:translate-x-[30vw] lg:translate-y-[14vh]
            `}
        >
            <div
            ...
            <div
                ...
                style={cardStyle}
            >
                <p className="font-bold text-sm sm:text-base mb-1">|| 신뢰할 수 있는 정보</p>
                <p className="text-xs sm:text-sm text-gray-200">
